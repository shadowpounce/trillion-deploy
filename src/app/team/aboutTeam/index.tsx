...
import danielAvatarSource from 'assets/daniel_berz.png';
import luisDanielAvatarSource from 'assets/luis-daniel_odon.png';
import valeriaAvatarSource from 'assets/valeria_mujica.png';
import luisFelipeAvatarSource from 'assets/luis-felipe_mujica.png';
...
const Team = () => {
  useEffect(() => {
    ...
    tl
    .fromTo(`.${styles.description}`, {opacity: 0, yPercent: 50}, {opacity: 1, yPercent: 0}, 0)
    .fromTo(`.${styles.title} .char`, {opacity: 0, stagger: 0.5}, {opacity: 1, stagger: 0.5}, 0)
    .fromTo(`.${styles.container} .badge`, { scale: 0 }, { scale: 1 }, 0)
    .fromTo(`.${styles.teammateCard}`, {opacity: 0, stagger: 0.5, yPercent: 30, ease: "back.out(3)", duration: 2}, {opacity: 1, stagger: 0.5, yPercent: 0, ease: "back.out(3)", duration: 2}, 0)
  }, [])
  return (
    <section className={styles.container}>
      <div className={styles.topContainer}>
        <h2 className={clsx(styles.title, styles.desktop)}>
          <Chars str={`Our <span class=${styles.bold}>Team</span>`} isSpace></Chars>
        </h2>
        <div className={styles.aboutUsContainer}>
          ...
          At Trillion Digital, our team is fast-paced, creative, and solution-driven. We thrive on tackling complex challenges and approach each opportunity with precision and integrity. Our culture is built around doing things right while staying agile and responsive to the evolving digital asset landscape.
          </p>
        </div>
      </div>
