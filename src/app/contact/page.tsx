...
import bg from "assets/bg-contact.webp"
  ...
  return (
    <main className="main">
      <section className={styles.section}>
        ...
        <Image src={bg as StaticImageData} alt="bg" className={styles.bg} />
        <h1 className={styles.title}>Contact Us</h1>
        <p className={styles.description}>
          Interested in our trading solutions? Our team is ready to help you.
          Contact us today and complete the onboarding process in less than 48
          hours.
        </p>
        <div className={styles.formWrapper}>
          <form action="#" onSubmit={handleFormSubmit}>
              ...
              {dataSoc.map(({id, value, icon}) => {
                return (
                  <div key={id} className={styles.radioInput}>
                    <input
                      onChange={({target}) =>
                        setFormData({...formData, contactMethod: target.value})
                      }
                      value={value}
                      required
                      type="radio"
              ...
              <div className={`${styles.input} ${styles.full}`}>
                ...
                <div className={styles.inputWrapper}>
                  <input
                    pattern="^@.*"
                    onChange={({target}) =>
                      setFormData({...formData, telegramUsername: target.value})
                    }
                    type="text"
            ...
            <div className={styles.message}>
              ...
              <div className={styles.inputWrapper}>
                <Image
                  src={greenCheck as StaticImageData}
                  alt="beforeIcon"
          ...
          <div className={styles.info}>
            <div className={styles.infoItem}>
              ...
              <a href="#">
                <Image
                  src={calendar as StaticImageData}
                  alt="call"
                  className={styles.icon}
                ></Image>
                Schedule a Meeting
              ...
              <a href="#">
                <Image
                  src={smsBlue as StaticImageData}
                  alt="call"
                  className={styles.icon}
                ></Image>
                Email Us
            ...
            <div className={styles.infoItem}>
              <h4>Call us</h4>
              <p className={styles.description}>
                Available Monday to Friday, 8:00 AM - 6:00 PM (ET)
              </p>
              <a target="_blank" href="tel:+13059083844">
                <Image
                  src={callBlue as StaticImageData}
                  alt="call"
                  className={styles.icon}
                ></Image>
                +1 (305) 908-3844
            ...
            <div className={styles.infoItem}>
              ...
              <a target="_blank" href="https://g.co/kgs/1SNcQSH">
                <Image
                  src={location as StaticImageData}
                  alt="call"
                  className={styles.icon}
                ></Image>
