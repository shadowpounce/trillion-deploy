      ...
      <div className={styles.centerContainer}>
        <div className={styles.tabletContainer}>
          ...
          <p className={styles.text}>
            <Chars str="Built for performance and reliability, our platform offers seamless
            access to deep liquidity with intuitive design, API integration, and
            fast execution to meet the demands of institutional trading." isSpace></Chars>
          </p>
