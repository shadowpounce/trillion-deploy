  ...
  return (
    <div className={styles.textContainer}>
          <p className={styles.text}>
            ...
            to provide accounting, legal, tax advice, or investment
            recommendations. Any services made available in the future will be
            subject to and made on the terms of the legal agreements relating
            thereto.
          </p>

          <p className={styles.text}>
            Trillion Capital Markets Inc d/b/a Trillion Digital is registered as
            an MSB with FinCEN (MSB Registration Number: 31000236132526) and
            holds a Money Transmitter License in the State of Florida (MTL
            License Number: FT230000409).
          </p>

          <p className={styles.text}>
            Trillion Capital Markets Inc d/b/a Trillion Digital is not
            registered or licensed with the U.S. Securities and Exchange
            Commission or the U.S. Commodity Futures Trading Commission.
            Trillion Capital Markets Inc d/b/a Trillion Digital services
            qualified participants; U/HNWI’s, qualified institutional buyers,
            and well-capitalized corporations.
          </p>

          <p className={styles.text}>
            For legal reasons, including adherence to OFAC sanctions compliance,
            we do not service Individuals, Corporations and Institutions
            ...
            Cuba, Iran, Iraq, Liberia, Libya, North Korea (DPRK), Palestine
            (Gaza Strip), Russian Federation, Somalia, South Sudan, Sudan,
            Syria, Ukraine, Yemen, Zimbabwe, or any members/affiliates of the
  ...
  return (
    ...
    className={styles.footer}>
        ...
        <div className={`${styles.resourcesWrapper}`}>
          ...
          <div className={`${styles.resourcesContainer}`}>
            ...
            <div className={styles.logosContainer}>
              ...
              <Link target='_blank' href='https://www.linkedin.com/company/trilliondigital/'>
                <Image
      ...
      <div className={styles.centralContainer}>
        <Badge isLink={true} link={'https://status.trilliondigital.io/'} title='All system operational' />
        {!isPhone && (
          <Text></Text>
        )}
      </div>
      ...
      <div className={styles.bottomContainer}>
        ...
        <div className={styles.linksWrapper}>
          ...
          <div className={`${styles.linksContainer} line-appearance-list`}>
            <Link href='/terms_and_conditions' className={styles.link}><Chars str="Website Terms and Conditions"></Chars></Link>
            <Link href='/terms_of_service' className={styles.link}><Chars str="Terms of Service"></Chars></Link>
            <Link href='/privacy_notice' className={styles.link}><Chars str="Privacy Policy"></Chars></Link>
            <Link href='/cookie_policy' className={styles.link}><Chars str="Cookies Policy"></Chars></Link>
